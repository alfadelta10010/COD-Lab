...
add x15,x13,x14    #addition of the two values
sw x15,0(x12)      #storing the added value in memory

lw x13,4(x10)     #loading the second element of a with offset 4
lw x14,4(x11)     #loading the second element of b with offset 4
add x16,x13,x14   #adding the second elements of a and b
sw x16,4(x12)     #storing the added value in memory with offset 4

lw x13,8(x10)    #loading the third element of a with offset 8
lw x14,8(x11)    #loading the third element of b with offset 8
add x17,x13,x14  #addition of third elements of a and b
sw x17,8(x12)    #storing the added value in memory with offset 8
