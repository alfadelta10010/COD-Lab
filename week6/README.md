...
- File name: `<SRN>_Week6_Lab.md` (eg: `PES2UG21EC003_Week6_Lab.md`)
```markdown
# Program 1: 
...
- `<SRN>_Week6_Lab.md` Markdown file, containing your observations for each program
...
:warning: **Deadline**: 11:59 PM, Saturday, 23rd November, 2024
